...
\appendix
\includepdf[pages={-}, scale=0.9]{_build/Monte-Carlo_Temperatures.pdf}
\includepdf[pages={-}, scale=0.9]{_build/Monte-Carlo_Energy.pdf}
\includepdf[pages={-}, scale=0.9]{_build/Monte-Carlo_Magnetisation.pdf}
\includepdf[pages={-}, scale=0.9]{_build/Cluster_Temperatures.pdf}
\includepdf[pages={-}, scale=0.9]{_build/Cluster_Energy.pdf}
\includepdf[pages={-}, scale=0.9]{_build/Cluster_Magnetisation.pdf}
